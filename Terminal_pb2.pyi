...
class PollutionData(_message.Message):
    ...
    pollution: float
    def __init__(self, datetime: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., pollution: _Optional[float] = ...) -> None: ...
...
class WellnessData(_message.Message):
    ...
    datetime: _timestamp_pb2.Timestamp
    wellness: float
    def __init__(self, datetime: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., wellness: _Optional[float] = ...) -> None: ...
